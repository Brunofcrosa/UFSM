...
void adicionaArco(Grafo* grafo, int origem, int destino) {
    NoAdj* novoNo = criaNoAdj(destino);
...
int main() {
    ...
    adicionaArco(meuGrafo, 0, 1);
    adicionaArco(meuGrafo, 0, 2);
    adicionaArco(meuGrafo, 1, 3);
    adicionaArco(meuGrafo, 2, 4);
    adicionaArco(meuGrafo, 3, 5);
    adicionaArco(meuGrafo, 4, 3);
    adicionaArco(meuGrafo, 5, 0);

    printf("Grafo de exemplo (Orientado, 6 vertices): Vertices 0 a 5\n");
    printf("Arcos: <0,1>, <0,2>, <1,3>, <2,4>, <3,5>, <4,3>, <5,0>\n");
    printf("\n");
